...
* [Mac OS X](system/mac/index.md)
* [Windows](system/windows/index.md)

### Tools

* [shell](tools/shell/index.md)
    * [dd硬盘测试速度](tools/shell/dd-speed-test.md)
    * [bash的字符串转义](tools/shell/string-escape.md)
    * [logrotate示例](tools/shell/logrotate-examples.md)
    * [ssh免密码登录](tools/shell/ssh-without-password.md)
    * [samba配置](tools/shell/samba.md)
* [Vim](tools/vim/index.md)
    * [环境变量](tools/vim/vim-current-env.md)
* [AWK](tools/awk.md)
* [GDB](tools/gdb.md)
* [Git](tools/git.md)
...
### Books
* [哲学家们都干了些什么](books/what-did-philosophers-do.md)
